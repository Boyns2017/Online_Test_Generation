...
(cl:defmethod cl:initialize-instance :after ((m <Hand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name table_simulator-msg:<Hand> is deprecated: use table_simulator-msg:Hand instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Hand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader table_simulator-msg:command-val is deprecated.  Use table_simulator-msg:command instead.")
  (command m))
